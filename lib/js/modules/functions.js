...
// load URLs in the top window 
// This was originally used inside documents with nested iframes. But, shouldn't be used anymore.
// TODO: planned deprecation after we get iFrame API calls and targeting working properly
// TODO: future options will be: load to iframe or use 'target=_blank' to open links in a new tab
...
export function showSuccessMsg() {
  ...
  console.groupCollapsed('Modules Loaded Successfully...');
